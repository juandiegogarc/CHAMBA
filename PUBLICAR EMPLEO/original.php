...
$db = mysqli_select_db($conexion, $basededatos) or die ("Error conexion al conectarse a la Base de datos");
    ...
    $contraseña=$_POST['constraseña']; //name="mensaje"

    //sentencia sql
    $sql="INSERT INTO datoss VALUES ('$nombre','$correo','$direccion','$telefono','$cuenta','$contraseña')"; //manda a traer los valores de '$nombre','$correo','$mensaje'
